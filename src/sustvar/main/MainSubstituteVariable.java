...
public class MainSubstituteVariable implements Runnable {
	...
	/**
	 * Extrae el valor del parámetro y realiza una tarea con dicho parámetro
	 * @param paramsMapped
	 * @param paramName
	 * @param task
	 */
	...
	/**
	 * Ajusta los valores de los parámetros para conservar sólo su valor y no su nombre. Dado que el formato es -nombre:valor
	 * @param paramsMapped
	 * @throws Exception
	 */
